...
FILES=("$MYDIR"/{browse-tui,mdless,mdcat,md-*,recipes/{browse-claude,browse-find,browse-fs,browse-git,browse-jira,browse-jira-mcp,browse-mcp,browse-md,browse-plan,browse-ps,md2ansi_lib.py,md_doc.py}})
