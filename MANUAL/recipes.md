...
| [`browse-claude`](recipes/browse-claude.md) | Claude Code history — projects → sessions → messages, with per-message JSON preview and a `1`-`6` detail filter (summary / voice / edits / tools / detailed / all). |
